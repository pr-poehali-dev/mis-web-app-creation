...
const Index = () => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'active': case 'available': return 'bg-medical-green text-white';
      case 'critical': case 'busy': return 'bg-medical-red text-white';
      case 'inactive': case 'offline': return 'bg-medical-gray text-white';
      ...
      <div className=\"flex\">
        ...
        <main className=\"flex-1 p-6\">
                      ...
                      {doctors.map(doctor => (
                        <div key={doctor.id} className=\"flex items-center justify-between p-3 bg-gray-50 rounded-lg\">
                          ...
                          <div className=\"text-right\">
                            <Badge className={
                              doctor.status === 'available' ? 'bg-green-600 text-white' :
                              doctor.status === 'busy' ? 'bg-orange-600 text-white' :
                              'bg-gray-600 text-white'
                            }>
          ...
          {activeTab === 'doctors' && (
            <div className=\"animate-fade-in\">
              <div className=\"mb-6\">
                <h2 className=\"text-3xl font-bold text-gray-900 font-inter\">Врачи</h2>
                <p className=\"text-gray-600 font-source\">Управление медицинским персоналом</p>
              </div>
